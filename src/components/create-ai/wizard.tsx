...
const STEPS: StepDef[] = [
  {
    ...
    hint: "Ej.: clínica estética, centro médico o consultorio dental",
    kind: "text",
  ...
  },
  {
    ...
    hint: "Ej.: tratamientos de rejuvenecimiento facial, implantes dentales o chequeo médico general",
    kind: "text",
  ...
  },
  {
    ...
    hint: "Ej.: personas de 30 a 55 años que buscan un diagnóstico orientativo antes de agendar una consulta",
    kind: "text",
